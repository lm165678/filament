...
public class View {
    ...
    */
    ...
    public void setDepthOfFieldOptions(@NonNull DepthOfFieldOptions options) {
        ...
        nSetDepthOfFieldOptions(getNativeObject(), options.focusDistance, options.enabled);
    }
    ...
    private static native void nSetDepthOfFieldOptions(long nativeView, float focusDistance, boolean enabled);
}
